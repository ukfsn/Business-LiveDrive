...
# -- generated at [Fri May 27 10:59:09 2011]
...
AddUsersToBusiness => {
    endpoint => 'http://www.livedrive.com/ResellersService/ResellerAPI.asmx',
    soapaction => 'http://www.livedrive.com/AddUsersToBusiness',
    namespace => 'http://www.livedrive.com/',
    parameters => [
      SOAP::Data->new(name => 'apiKey', type => 's:string', attr => {}),
      ...
      SOAP::Data->new(name => 'userCapacity', type => 's:string', attr => {}),
    ], # end parameters
  }, # end AddUsersToBusiness
UpgradeUser => {
    endpoint => 'http://www.livedrive.com/ResellersService/ResellerAPI.asmx',
...
UpdateBusinessDetails => {
    endpoint => 'http://www.livedrive.com/ResellersService/ResellerAPI.asmx',
    soapaction => 'http://www.livedrive.com/UpdateBusinessDetails',
    namespace => 'http://www.livedrive.com/',
    parameters => [
      SOAP::Data->new(name => 'apiKey', type => 's:string', attr => {}),
      SOAP::Data->new(name => 'userID', type => 's:int', attr => {}),
      SOAP::Data->new(name => 'productType', type => 's:string', attr => {}),
      SOAP::Data->new(name => 'companyName', type => 's:string', attr => {}),
      SOAP::Data->new(name => 'subdomain', type => 's:string', attr => {}),
    ], # end parameters
  }, # end UpdateBusinessDetails
UpdateUser => {
    endpoint => 'http://www.livedrive.com/ResellersService/ResellerAPI.asmx',
...
AddBusinessUser => {
    endpoint => 'http://www.livedrive.com/ResellersService/ResellerAPI.asmx',
    soapaction => 'http://www.livedrive.com/AddBusinessUser',
    namespace => 'http://www.livedrive.com/',
    parameters => [
      SOAP::Data->new(name => 'apiKey', type => 's:string', attr => {}),
      SOAP::Data->new(name => 'email', type => 's:string', attr => {}),
...
AddStorageCapacityToBusiness => {
    endpoint => 'http://www.livedrive.com/ResellersService/ResellerAPI.asmx',
    soapaction => 'http://www.livedrive.com/AddStorageCapacityToBusiness',
    namespace => 'http://www.livedrive.com/',
    parameters => [
      SOAP::Data->new(name => 'apiKey', type => 's:string', attr => {}),
      SOAP::Data->new(name => 'userID', type => 's:int', attr => {}),
      SOAP::Data->new(name => 'cardVerificationValue', type => 's:string', attr => {}),
      SOAP::Data->new(name => 'productType', type => 's:string', attr => {}),
      SOAP::Data->new(name => 'spaceCapacity', type => 's:string', attr => {}),
    ], # end parameters
  }, # end AddStorageCapacityToBusiness
CloseUser => {
    endpoint => 'http://www.livedrive.com/ResellersService/ResellerAPI.asmx',
    soapaction => 'http://www.livedrive.com/CloseUser',
    namespace => 'http://www.livedrive.com/',
    parameters => [
      SOAP::Data->new(name => 'apiKey', type => 's:string', attr => {}),
      SOAP::Data->new(name => 'userID', type => 's:int', attr => {}),
